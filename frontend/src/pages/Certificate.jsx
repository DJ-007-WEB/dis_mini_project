    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900">No Certificates Yet</h2>
          <p className="text-gray-500 mt-2">Complete a course to earn your first certificate!</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Your Certificate</h1>
        ...
        <div className="border-4 border-emerald-600 p-12 text-center relative overflow-hidden bg-gradient-to-br from-slate-50 to-emerald-50">
          ...
          <div className="flex justify-between items-end px-12 mt-12 relative z-10">
            <div className="text-center">
              ...
              <div className="text-sm font-bold text-gray-600 uppercase tracking-wider">Date Issued</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="w-24 h-24 mx-auto border-4 border-emerald-600 rounded-full flex items-center justify-center bg-emerald-600 shadow-inner mb-4 relative">
                ...
                <span className="text-white font-bold text-xs uppercase text-center leading-tight">LearnHub<br/>Certified</span>
              </div>
            </div>

            <div className="text-center">
              <div className="border-b border-gray-400 pb-2 mb-2 w-48 relative">
                <span className="font-script text-3xl text-slate-900 absolute bottom-1 left-1/2 transform -translate-x-1/2 font-signature">J. Doe</span>
              </div>
              <div className="text-sm font-bold text-gray-600 uppercase tracking-wider">Director of Education</div>
            </div>
          </div>
        </div>
      </div>
